...
function server_msg.jqr_yz(msg)
	-- LOG_DEBUG("机器人押注！！！！！！！！！！！！！！！！！！！")
	send_to_server("PourFQZS", {pourobject = msg.object ,pourmoney = msg.money})
end

function server_msg.jqr_qz(msg)
	-- LOG_DEBUG("机器人抢庄~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	send_to_server("UpDownMasterFQZS", {opt = 1})
end
